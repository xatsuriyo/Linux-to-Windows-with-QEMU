...
link1_status=$(curl -Is https://archive.org/download/WinServer2019x64/en_windows_server_2019_x64_dvd_4cb967d8.iso | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is https://archive.org/download/WinServer2019x64/en_windows_server_2019_x64_dvd_4cb967d8.iso | grep HTTP | cut -f2 -d" ")
